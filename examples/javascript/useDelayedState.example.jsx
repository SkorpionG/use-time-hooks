...
export function DelayedNotificationExample() {
  ...
  const [delayedMessage, setDelayedMessage, { isDelayed, cancel, flush }] =
  ...
  return (
    <div>
      ...
      <p>
        Notifications appear immediately, then get confirmed after 2 seconds
      </p>
      ...
      <div>
        ...
        {isDelayed && (
          <>
            ...
            <button onClick={handleFlush}>Confirm Now</button>
          </>
        )}
      </div>
...
export function OptimisticUIExample() {
  ...
  const [delayedItems, setDelayedItems, { isDelayed, cancel }] =
    useDelayedState([], 3000);
...
export function AutoSaveExample() {
  ...
  const [savedContent, setSavedContent, { isDelayed, flush }] = useDelayedState(
    '',
    1500
  );
