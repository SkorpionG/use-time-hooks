  ...
  return (
    <div>
      ...
      <div>
        ...
        <button onClick={handleBatchedUpdates}>3 Batched Updates</button>
        <button onClick={handleRapidUpdates}>5 Rapid Updates</button>
...
export function BatchedFormExample() {
  ...
  return (
    <div>
      ...
      <p>
        Renders: {renderCount} | Pending: {pendingCount}
      </p>
      ...
      <div>
        <button onClick={handleBulkUpdate}>Fill Form (Batched)</button>
